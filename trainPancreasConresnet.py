...
def main():
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        trainloader, train_sampler = engine.get_train_loader(PancreasDataSet(args.train_list, max_iters=args.num_steps * args.batch_size, crop_size=input_size,
                        scale=args.random_scale, mirror=args.random_mirror))
        valloader, val_sampler = engine.get_test_loader(PancreasValDataSet(args.val_list))
